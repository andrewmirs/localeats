...
class GooglePlaces extends Component {
    ...
    selectLocation = async (placeid) => {
        ...
        const apiUrl = `https://maps.googleapis.com/maps/api/place/details/json?key=${api_key}&placeid=${placeid}&fields=name,formatted_address,photo,rating,website,id,formatted_phone_number`;
        try {
            const result = await fetch(apiUrl);
            const json = await result.json();
            this.setState({
